...
NSString *const kPAPUserProfilePicMediumKey                     = @"profilePictureSmall";
...
// Class key
NSString *const kPAPPhotoClassKey = @"MPOFile";

// Field keys
NSString *const kPAPPhotoPictureKey         = @"thumb";
NSString *const kPAPPhotoThumbnailKey       = @"thumb";
NSString *const kPAPPhotoUserKey            = @"userObject";
