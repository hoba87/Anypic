...
- (void)viewDidLoad {
    ...
    [texturedBackgroundView setBackgroundColor:[UIColor dimensivaBackgroundColor]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.objects.count) {
        ...
        if ([activity objectForKey:kPAPActivityPhotoKey]) {
            ...
            PAPAccountViewController *detailViewController = [[PAPAccountViewController alloc] init];//WithStyle:UITableViewStylePlain];
...
- (void)cell:(PAPBaseTextCell *)cellView didTapUserButton:(PFUser *)user {    
    ...
    PAPAccountViewController *accountViewController = [[PAPAccountViewController alloc] init];// initWithStyle:UITableViewStylePlain];
